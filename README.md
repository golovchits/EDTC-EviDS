> **EviDS-UAV fork (E1)** — extends EDTC with an evidential Dirichlet head for vacuity-gated detection-tracking handoff in thermal single-object tracking. See [EviDS-UAV](https://github.com/golovchits/EviDS-UAV) for the full framework.
